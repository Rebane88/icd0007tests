...
test('Distributes numbers into sets', function () {

    chdir(getProjectDirectory() . '/ex6');
...
test('Finds contacts with phones', function () {

    chdir(getProjectDirectory() . '/ex6/phones');
...
test('Menu has two root items', function () {

    chdir(getProjectDirectory() . '/ex6/menu');
...
test('First menu item has correct sub structure', function () {
...
test('Second menu item has correct sub structure', function () {
